...
def split_stratified_sets(df, target_col, test_ratio=0.2, to_numpy=False):
    """Split sets stratified on target variable
    ...
    X_data, X_test, y_data, y_test = train_test_split(features, target, test_size=test_ratio, stratify=target, random_state=8)
    
    val_ratio = test_ratio / (1 - test_ratio)
    X_train, X_val, y_train, y_val = train_test_split(X_data, y_data, test_size=val_ratio, stratify=y_data, random_state=8)
